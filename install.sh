...
echo ""
echo "  2. KYTOS_INDIVIDUAL_DIR 환경변수를 셸 프로필에 추가합니다:"
echo "     echo 'export KYTOS_INDIVIDUAL_DIR=\$HOME/kytos-data' >> ~/.zshrc"
echo "     source ~/.zshrc"
echo ""
echo "  3. Claude Code를 실행하고 me.json을 인터뷰 방식으로 작성합니다:"
echo "     claude"
echo "     /kytos-setup"
echo ""
